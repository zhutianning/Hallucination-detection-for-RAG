...
BASELINE_PATH = BASE_DIR / "outputs" / "no_rag_top1_pred_test_advanced_500_llama-3.1-70b-instruct.json" # baseline file
RAG_PATH = BASE_DIR / "rag_top1_pred_llama-3.1-70b-instruct.json" # rag output file
